...
export interface Venue { id: number; name: string; area: string; address: string; venue_type: string; price_range: string; reservation_required?: boolean; photos?: VenuePhoto[]; is_favorited?: boolean }
